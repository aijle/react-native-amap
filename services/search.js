...
export const AMapDistanceSearch = searchRequstFactory('distanceSearch')
export const AMapTruckRouteSearch = searchRequstFactory('truckRouteSearch')
export const AMapDrivingRouteSearch = searchRequstFactory('drivingRouteSearch')
export const AMapWalkingRouteSearch = searchRequstFactory('walkingRouteSearch')
export const AMapRidingRouteSearch = searchRequstFactory('ridingRouteSearch')
export const AMapTransitRouteSearch = searchRequstFactory('transitRouteSearch')
export const AMapGetPoiAroundSearch = searchRequstFactory('poiAroundSearch')
